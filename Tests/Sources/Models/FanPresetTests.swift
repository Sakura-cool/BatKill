...
final class FanPresetTests: TestCase {
    ...
    func testFanPresetStoreRemoveBuiltIn() {
    ...
    func testFanPresetStoreActivate() {
    ...
    func testFanPresetStoreAutoPreset() {
    ...
    func testFanPresetStorePersistence() {
